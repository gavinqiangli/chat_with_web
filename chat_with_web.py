...
st.set_page_config(page_title="Chat with Websites", page_icon=":penguin:")
st.title(":penguin: Chat with Websites")
...
def configure_retriever(site_url):
    ...
    docs = text_splitter.create_documents(site_content)
...
url = st.sidebar.text_input(
   "Please type in the url of website."
)
if not url:
    st.info("Please type in website url to continue.")
    st.stop()
